...
const TextScroll = ({ currentTheme }) => {
    ...
    return (
        <section ref={sectionRef} className={`min-h-[80vh] flex items-center justify-center transition-colors duration-500 ${isNoir ? 'bg-[#0a0a0a]' : 'bg-[#FDFBF7]'} px-8 md:px-20 py-24 relative z-20`}>
